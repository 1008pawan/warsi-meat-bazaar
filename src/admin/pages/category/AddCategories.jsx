...
const AddCategories = () => {
  ...
  const { mutate, isPending } = useSubCreateCategory();
    ...
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-3 gap-4 bg-white p-5 rounded-3xl border border-zinc-300">
        ...
        <div className="bg-white rounded-3xl">
          <h2 className="font-bold text-xl mb-5">Category Image</h2>
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl">
          <h2 className="text-xl font-bold mb-8">Category Information</h2>
