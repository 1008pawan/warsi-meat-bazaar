...
import { useUpdateCategory } from "../../../hooks/useAdminCategories";
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500">Update a product category</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-4 bg-white p-5 rounded-3xl border border-zinc-300">
        ...
        <div className="bg-white rounded-3xl">
          <h2 className="font-bold text-xl mb-5">Update Category Image</h2>
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl">
          <h2 className="text-xl font-bold mb-8">Update Category Information</h2>
