...
import { useUpdateOffer } from "../../../hooks/useAdminOffers";
...
const UpdateOffers = () => {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      reward_qty: offer.reward_qty,
      is_first_order: String(offer.is_first_order),
      status: offer.status,
      units: offer.units,
      image: null,
    });
    ...
    if (offer.image) {
      setPreview(`${STORAGE_URL}/${offer.image}`);
    }
  }, [offer]);
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("min_amount", form.min_amount);
    formData.append("reward_type", form.reward_type);
    formData.append("reward_qty", form.reward_qty);
    formData.append("is_first_order", form.is_first_order);
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Update promotional offers for your customers.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid lg:grid-cols-3 gap-8 bg-white rounded-3xl border border-zinc-300 shadow-sm p-6">
          ...
          <div className="bg-white">
            <h2 className="font-bold text-xl mb-5">Update Offer Image</h2>
          ...
          <div className="lg:col-span-2 bg-white">
            <h2 className="font-bold text-2xl mb-8">Update Offer Details</h2>
